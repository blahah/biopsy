...
a = { 
  :assembly => File.absolute_path('testset/1.scafSeq'),
  :reference => File.absolute_path('testset/ref.fa'),
  :assemblyname => 'test',  
  :leftreads => File.absolute_path('testset/l.fq'),
  :rightreads => File.absolute_path('testset/r.fq'),
  :insertsize => 200,
  :insertsd => 50
}
